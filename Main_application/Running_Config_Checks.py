...
def hostnames_to_config_backup_file_mapping(list_of_filenames : list, list_of_hostnames: numpy.array, parent_directory_of_config_backup_files : str) -> dict:
    """
...
def running_config_checks(**kwargs) -> str:
    ...
    global log_file; log_file = os.path.join(log_file_path,"Running_Config_Checks(Node_Checks).log")
