...
def sheet_creater(**kwargs) -> str:
    ...
    try:
        ...
        while i < host_ips_sheets_required.size:
            ...
            logging.debug(
                f"Checking the condition for {not host_ips_sheets_required[i] in host_ips_sheetnames_present_in_the_workbook}")
        ...
        try:
            ...
            while i < unique_vendors_in_host_details.size:
                host_ips_sheets_required = host_details_df[
                    host_details_df['Vendor'] == unique_vendors_in_host_details[i]]
