...
"}")
        ...
        QWidget.setTabOrder(self.file_browser_pushButton, self.sheet_creator_pushButton)
        QWidget.setTabOrder(self.sheet_creator_pushButton, self.submit_button_pushButton)
        QWidget.setTabOrder(self.submit_button_pushButton, self.file_browser_path_lineEdit)
